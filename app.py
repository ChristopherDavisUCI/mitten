...
st.write("(This is only tested on Chrome.)  Have Underdog email you your exposure csv file and upload it below.  (As far as I can tell, this is only possible from the Exposure section on Desktop, not Mobile.)")
